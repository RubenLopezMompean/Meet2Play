...
/* acp_language.html */
class __TwigTemplate_98bc0c9664272f32e11b0f305d4f0a87578e4ba3fd03a6106f6d74364b37ee47 extends Twig_Template
{
...
\t";
            // line 39
            if (twig_length_filter($this->env, $this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "missing_files", array()))) {
                // line 40
                echo "\t\t<h3 class=\"error\">";
...
\t\t\t";
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "missing_files", array()));
...
\t";
            // line 50
            if (twig_length_filter($this->env, $this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "missing_varfile", array()))) {
                // line 51
                echo "\t\t<h3 class=\"error\">";
...
\t\t\t";
                // line 55
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "missing_varfile", array()));
...
\t";
            // line 89
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "lang", array()));
...
\t";
            ...
            // line 98
            echo "\t";
            if (twig_length_filter($this->env, $this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "notinst", array()))) {
                // line 99
                echo "\t<tr>
\t\t<td class=\"row3\" colspan=\"5\"><strong>";
                // line 100
...
\t";
            ...
            echo "\t";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "notinst", array()));
