...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001046af310000000067537212(
...
class phpbbtemplatetwiglexer_000000001046af310000000067537212 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59186c7cd68fe337302845 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59186c7cd6908799657857 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59186c7cd68d9158405047 = array(
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, 'set_environment', array('env' => $env), $this->initializer59186c7cd6908799657857);

        return $this->valueHolder59186c7cd68fe337302845->set_environment($env);
    }
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59186c7cd6908799657857);

        return $this->valueHolder59186c7cd68fe337302845->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59186c7cd6908799657857);

        return $this->valueHolder59186c7cd68fe337302845->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59186c7cd6908799657857 = $initializer;
    }
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, '__get', array('name' => $name), $this->initializer59186c7cd6908799657857);

        if (isset(self::$publicProperties59186c7cd68d9158405047[$name])) {
            return $this->valueHolder59186c7cd68fe337302845->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59186c7cd68fe337302845;
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59186c7cd6908799657857);
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, '__isset', array('name' => $name), $this->initializer59186c7cd6908799657857);
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, '__unset', array('name' => $name), $this->initializer59186c7cd6908799657857);
    ...
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, '__clone', array(), $this->initializer59186c7cd6908799657857);

        $this->valueHolder59186c7cd68fe337302845 = clone $this->valueHolder59186c7cd68fe337302845;
    }

    public function __sleep()
    {
        $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, '__sleep', array(), $this->initializer59186c7cd6908799657857);

        return array('valueHolder59186c7cd68fe337302845');
    }
    ...
    {
        return $this->initializer59186c7cd6908799657857;
    }
    ...
    {
        return $this->initializer59186c7cd6908799657857 && $this->initializer59186c7cd6908799657857->__invoke($this->valueHolder59186c7cd68fe337302845, $this, 'initializeProxy', array(), $this->initializer59186c7cd6908799657857);
    }
    ...
    {
        return null !== $this->valueHolder59186c7cd68fe337302845;
    }
    ...
    {
        return $this->valueHolder59186c7cd68fe337302845;
    }
